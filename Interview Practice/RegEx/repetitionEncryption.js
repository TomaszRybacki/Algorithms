...
your help with calculating the number of pairs of consecutive equal words.
...
They are shown in different colors below:
...
console.log(repetitionEncryption("Hi, hi Jane! I'm so. So glad to to finally be able to write - WRITE!! - to you!")); // 4
console.log(repetitionEncryption("Yo-yo, how's s it going going for ya? Ya is okay, okay'nt ya?")); // 5
console.log(repetitionEncryption('Hi Jane, how are you doing today?')); // 0
console.log(repetitionEncryption('My friend, friend of mine, I am really-really happy for you! You are amazing, please write me back when you can.')); // 3
console.log(repetitionEncryption('ho-ho--he-he')); // 2
console.log(repetitionEncryption('Do not notify me about this in the future')); // 0
